...
export const RestaurantHeroSection = () => {
  ...
  return (
    <section className="py-32 text-center bg-gray-50 bg-cover bg-center bg-no-repeat relative" style={{ backgroundImage: 'url(/slide-6.png)' }}>
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
            Vos invendus ont
            <br />
            une <span className="text-warning-400">seconde vie</span>
          </h1>
