    ...
    >
      <div className="bg-white rounded-2xl sm:rounded-3xl max-w-md w-full shadow-2xl animate-fade-in-up border border-gray-100">
        ...
        <div className="bg-gradient-to-br from-red-500 via-red-600 to-red-700 p-4 sm:p-6 text-white relative overflow-hidden">
          ...
          <h3 className="text-xl sm:text-2xl font-bold text-center">Supprimer les lots sélectionnés ?</h3>
        </div>
        ...
        <div className="p-4 sm:p-6 space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-red-700 leading-relaxed">
                  <strong className="text-red-800">{selectedCount} lot{selectedCount > 1 ? 's' : ''}</strong> seront définitivement supprimé{selectedCount > 1 ? 's' : ''} et ne pourront pas être distribués.
                </p>
          ...
          {eligibleForDonCount > 0 && onSuggestDon && (
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-green-700 leading-relaxed">
                    <strong className="text-green-800">{eligibleForDonCount} lot{eligibleForDonCount > 1 ? 's' : ''}</strong> {eligibleForDonCount > 1 ? 'peuvent' : 'peut'} être passé{eligibleForDonCount > 1 ? 's' : ''} en don et bénéficier aux personnes dans le besoin.
                  </p>
                  <button
          ...
          <div className="text-center">
            <p className="text-gray-600 text-sm font-medium">
              Êtes-vous sûr de vouloir supprimer ces lots ?
            </p>
