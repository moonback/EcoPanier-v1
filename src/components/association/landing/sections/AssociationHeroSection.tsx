...
const heroHighlights = [
  {
    icon: Building2,
    label: '100% gratuit pour les associations',
  },
  {
    icon: Users,
    label: 'Gestion simplifiée des bénéficiaires',
  },
];
...
const heroStats = [
  ...
  { value: '5000+', label: 'Bénéficiaires accompagnés' },
];
        ...
        >
          ...
          <div className="space-y-6">
            <h1 className="text-4xl font-semibold text-neutral-900 sm:text-5xl">
              Simplifiez la gestion de votre aide alimentaire et accompagnez vos bénéficiaires en toute dignité.
            </h1>
            <p className="max-w-xl text-lg leading-relaxed text-neutral-600">
              Une plateforme complète pour enregistrer, gérer et suivre vos bénéficiaires. ÉcoPanier vous permet de faciliter l'accès à l'aide alimentaire tout en préservant la dignité de vos bénéficiaires.
            </p>
          </div>
        ...
        >
          <div className="space-y-3">
            ...
            <p className="text-2xl font-semibold text-neutral-900">
              Plus de 5000 bénéficiaires accompagnés par nos associations partenaires.
            </p>
            <p className="text-sm text-neutral-600">
              Chiffres issus des tests 2025 réalisés auprès d'associations solidaires franciliens et nantais.
            </p>
          </div>
